...
<table>
    ...
    <tr>
        <td><s:message code="message.label.report.quest-score"/></td>
        <td><c:out value="${quest_score}"/>
        <s:message code="message.label.report.quest-score-from"/>
        <c:out value="${quest_total}"/></td>
    </tr>
</table>
